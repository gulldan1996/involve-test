...
export const getCalculateLoading = state => state.calculateLoading;
export const getConfirmData = state => state.confirmData;
export const getSuccess = state => state.success;
export const getExchangeLoading = state => state.exchangeLoading;
